...
namespace Characters
{
    class HumanSpecials
    {
        public static string[] AnySpecials = new string[] {"Potato", "Escape", "Dance", "Distract", "Supply", "SmokeBomb", "Carry", "AirDodge"};
        ...
        public static BaseUseable GetSpecialUseable(BaseCharacter owner, string special)
        {
            ...
            else if (special == "AirDodge") // added by Ata 2 May 2024 //
                return new AirDodgeSpecial(owner);
            return null;
        }
