namespace Settings
{
    class InGameCharacterSettings : BaseSettingsContainer
    {
        ...
        public StringSetting Special_2 = new StringSetting(string.Empty); // added by Ata 12 May 2024 - Three Wheel Special //
        public StringSetting Special_3 = new StringSetting(string.Empty); // added by Ata 12 May 2024 - Three Wheel Special //
